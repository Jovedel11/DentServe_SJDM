...
CREATE OR REPLACE FUNCTION "public"."approve_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
BEGIN
    ...
    -- ✅ CORRECT: Only patients can book
    ...
    -- ✅ CRITICAL: Rate limiting (get user email first)
    ...
    -- ✅ CRITICAL: Check appointment limits FIRST
    ...
    -- ✅ ENHANCED: Comprehensive validation with better error handling
    WITH comprehensive_validation AS (
        SELECT 
            ...
            -- ✅ FIXED: Check for patient time conflicts
    ...
    -- ✅ CRITICAL: Check doctor availability
    ...
    -- ✅ Get patient reliability (for informational purposes)
    reliability_check := check_patient_reliability(patient_id_val, p_clinic_id);

    -- ✅ TRANSACTION: Create appointment atomically
    BEGIN
        INSERT INTO appointments (
            ...
            validation_result.total_duration,
            p_symptoms,
            'pending'  -- ✅ CRITICAL: Always pending for staff approval
        ...
        -- ✅ ENHANCED: Create notification for patient AND staff
        ...
        -- ✅ SUCCESS: Return comprehensive booking data
        RETURN jsonb_build_object(
            'success', true,
...
ALTER FUNCTION "public"."check_rate_limit_unified"("p_user_email" character varying, "p_action_type" character varying, "p_max_attempts" integer, "p_window_minutes" integer, "p_is_success" boolean) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."create_user_email_only"("p_email" character varying, "p_first_name" character varying, "p_last_name" character varying, "p_user_type" "public"."user_type" DEFAULT 'patient'::"public"."user_type") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    user_id UUID;
...
CREATE OR REPLACE FUNCTION "public"."geocode_clinic_address"("p_address" "text", "p_city" "text" DEFAULT 'San Jose Del Monte'::"text", "p_province" "text" DEFAULT 'Bulacan'::"text", "p_country" "text" DEFAULT 'Philippines'::"text") RETURNS "extensions"."geography"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    full_address text;
...
ALTER FUNCTION "public"."geocode_clinic_address"("p_address" "text", "p_city" "text", "p_province" "text", "p_country" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_clinic_timezone"("p_clinic_id" "uuid") RETURNS character varying
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_clinic_timezone"("p_clinic_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_partnership_requests"("p_status" "text" DEFAULT NULL::"text", "p_limit" integer DEFAULT 20, "p_offset" integer DEFAULT 0) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    current_user_context jsonb;
...
ALTER FUNCTION "public"."get_partnership_requests"("p_status" "text", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."manage_partnership_request"("p_request_id" "uuid", "p_action" "text", "p_admin_notes" "text" DEFAULT NULL::"text", "p_clinic_data" "jsonb" DEFAULT NULL::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    current_user_context JSONB;
...
ALTER FUNCTION "public"."manage_partnership_request"("p_request_id" "uuid", "p_action" "text", "p_admin_notes" "text", "p_clinic_data" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."queue_staff_invitation_email"("p_invitation_data" "jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    queue_id UUID;
...
ALTER FUNCTION "public"."queue_staff_invitation_email"("p_invitation_data" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."reject_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text" DEFAULT NULL::"text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    current_user_context jsonb;
...
ALTER FUNCTION "public"."reject_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."submit_clinic_partnership_request"("p_clinic_name" character varying, "p_email" character varying, "p_address" "text", "p_reason" "text", "p_staff_name" character varying, "p_contact_number" character varying) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."track_appointment_deletion_in_history"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."track_appointment_deletion_in_history"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION public.update_patient_profile(
    ...
    p_patient_data jsonb DEFAULT '{}'::jsonb
)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
-- Create the WORKING staff profile update function (WITHOUT GEOGRAPHY)
CREATE OR REPLACE FUNCTION public.update_staff_profile(
    p_profile_data jsonb DEFAULT '{}'::jsonb,
    p_staff_data jsonb DEFAULT '{}'::jsonb,
...
BEGIN
    ...
    -- 5️⃣ SERVICES MANAGEMENT - PROPER ARRAY ITERATION
    IF jsonb_typeof(p_services_data) = 'array' AND jsonb_array_length(p_services_data) > 0 AND staff_clinic_id IS NOT NULL THEN
        FOR service_item IN SELECT * FROM jsonb_array_elements(p_services_data)
        LOOP
            IF service_item ? 'id' THEN
                service_id := (service_item->>'id')::UUID;
                
                -- Update existing service
                UPDATE services 
                SET 
                    name = COALESCE(service_item->>'name', name),
                    description = COALESCE(service_item->>'description', description),
                    price = COALESCE((service_item->>'price')::decimal, price),
                    duration = COALESCE((service_item->>'duration')::integer, duration),
                    is_active = COALESCE((service_item->>'is_active')::boolean, is_active),
                    updated_at = NOW()
                WHERE id = service_id AND clinic_id = staff_clinic_id;
            END IF;
        END LOOP;
        
        result := result || jsonb_build_object('services_updated', jsonb_array_length(p_services_data));
    END IF;
    
    -- 6️⃣ DOCTORS MANAGEMENT - PROPER ARRAY ITERATION
    IF jsonb_typeof(p_doctors_data) = 'array' AND jsonb_array_length(p_doctors_data) > 0 AND staff_clinic_id IS NOT NULL THEN
        FOR doctor_item IN SELECT * FROM jsonb_array_elements(p_doctors_data)
        LOOP
            IF doctor_item ? 'id' THEN
                doctor_id := (doctor_item->>'id')::UUID;
                
                -- Update existing doctor
                UPDATE doctors 
                SET 
                    name = COALESCE(doctor_item->>'name', name),
                    specialization = COALESCE(doctor_item->>'specialization', specialization),
                    license_number = COALESCE(doctor_item->>'license_number', license_number),
                    phone = COALESCE(doctor_item->>'phone', phone),
                    email = COALESCE(doctor_item->>'email', email),
                    bio = COALESCE(doctor_item->>'bio', bio),
                    image_url = COALESCE(doctor_item->>'image_url', image_url),
                    is_active = COALESCE((doctor_item->>'is_active')::boolean, is_active),
                    updated_at = NOW()
                WHERE id = doctor_id;
                
                -- Update doctor-clinic relationship if needed
                UPDATE doctor_clinics 
                SET 
                    consultation_fee = COALESCE((doctor_item->>'consultation_fee')::decimal, consultation_fee),
                    is_available = COALESCE((doctor_item->>'is_available')::boolean, is_available),
                    updated_at = NOW()
                WHERE doctor_id = doctor_id AND clinic_id = staff_clinic_id;
            END IF;
        END LOOP;
        
        result := result || jsonb_build_object('doctors_updated', jsonb_array_length(p_doctors_data));
    END IF;
...
CREATE OR REPLACE FUNCTION "public"."validate_appointment_services"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."validate_appointment_services"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_doctor_clinic_assignment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."validate_doctor_clinic_assignment"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."validate_feedback_appointment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."validate_feedback_appointment"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."services" (
    ...
    CONSTRAINT "valid_duration_check" CHECK ((("duration_minutes" > 0) AND ("duration_minutes" <= 480)))
);
...
CREATE INDEX "idx_appointments_doctor_datetime_availability" ON "public"."appointments" USING "btree" ("doctor_id", "appointment_date", "appointment_time", "status") WHERE ("status" = ANY (ARRAY['pending'::"public"."appointment_status", 'confirmed'::"public"."appointment_status"]));
...
CREATE INDEX "idx_appointments_patient_reliability" ON "public"."appointments" USING "btree" ("patient_id", "clinic_id", "status", "appointment_date") WHERE ("status" = ANY (ARRAY['completed'::"public"."appointment_status", 'no_show'::"public"."appointment_status", 'cancelled'::"public"."appointment_status"]));
...
CREATE OR REPLACE TRIGGER "track_appointment_deletion_trigger" BEFORE DELETE ON "public"."appointments" FOR EACH ROW EXECUTE FUNCTION "public"."track_appointment_deletion_in_history"();
...
CREATE OR REPLACE TRIGGER "validate_appointment_services_trigger" BEFORE INSERT OR UPDATE ON "public"."appointment_services" FOR EACH ROW EXECUTE FUNCTION "public"."validate_appointment_services"();



CREATE OR REPLACE TRIGGER "validate_doctor_clinic_trigger" BEFORE INSERT OR UPDATE ON "public"."appointments" FOR EACH ROW EXECUTE FUNCTION "public"."validate_doctor_clinic_assignment"();



CREATE OR REPLACE TRIGGER "validate_feedback_appointment_trigger" BEFORE INSERT OR UPDATE ON "public"."feedback" FOR EACH ROW EXECUTE FUNCTION "public"."validate_feedback_appointment"();
...
ALTER TABLE ONLY "public"."patient_medical_history"
    ADD CONSTRAINT "patient_medical_history_appointment_id_fkey" FOREIGN KEY ("appointment_id") REFERENCES "public"."appointments"("id") ON DELETE SET NULL;
...
GRANT ALL ON FUNCTION "public"."approve_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."approve_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."approve_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."check_rate_limit_unified"("p_user_email" character varying, "p_action_type" character varying, "p_max_attempts" integer, "p_window_minutes" integer, "p_is_success" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."check_rate_limit_unified"("p_user_email" character varying, "p_action_type" character varying, "p_max_attempts" integer, "p_window_minutes" integer, "p_is_success" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_rate_limit_unified"("p_user_email" character varying, "p_action_type" character varying, "p_max_attempts" integer, "p_window_minutes" integer, "p_is_success" boolean) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_user_email_only"("p_email" character varying, "p_first_name" character varying, "p_last_name" character varying, "p_user_type" "public"."user_type") TO "anon";
GRANT ALL ON FUNCTION "public"."create_user_email_only"("p_email" character varying, "p_first_name" character varying, "p_last_name" character varying, "p_user_type" "public"."user_type") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_user_email_only"("p_email" character varying, "p_first_name" character varying, "p_last_name" character varying, "p_user_type" "public"."user_type") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."geocode_clinic_address"("p_address" "text", "p_city" "text", "p_province" "text", "p_country" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."geocode_clinic_address"("p_address" "text", "p_city" "text", "p_province" "text", "p_country" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."geocode_clinic_address"("p_address" "text", "p_city" "text", "p_province" "text", "p_country" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_clinic_timezone"("p_clinic_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_clinic_timezone"("p_clinic_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_clinic_timezone"("p_clinic_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_partnership_requests"("p_status" "text", "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_partnership_requests"("p_status" "text", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_partnership_requests"("p_status" "text", "p_limit" integer, "p_offset" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."manage_partnership_request"("p_request_id" "uuid", "p_action" "text", "p_admin_notes" "text", "p_clinic_data" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."manage_partnership_request"("p_request_id" "uuid", "p_action" "text", "p_admin_notes" "text", "p_clinic_data" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."manage_partnership_request"("p_request_id" "uuid", "p_action" "text", "p_admin_notes" "text", "p_clinic_data" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."queue_staff_invitation_email"("p_invitation_data" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."queue_staff_invitation_email"("p_invitation_data" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."queue_staff_invitation_email"("p_invitation_data" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."reject_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."reject_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."reject_partnership_request"("p_request_id" "uuid", "p_admin_notes" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."track_appointment_deletion_in_history"() TO "anon";
GRANT ALL ON FUNCTION "public"."track_appointment_deletion_in_history"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."track_appointment_deletion_in_history"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_appointment_services"() TO "anon";
GRANT ALL ON FUNCTION "public"."validate_appointment_services"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_appointment_services"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_doctor_clinic_assignment"() TO "anon";
GRANT ALL ON FUNCTION "public"."validate_doctor_clinic_assignment"() TO "authenticated";
